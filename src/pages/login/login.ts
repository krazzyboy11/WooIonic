...
export class LoginPage {
  ...
  login(){
    this.http.get("https://demo1.tusharahmed.com/api/auth/generate_auth_cookie/?insecure=cool&username=" +this.username + "&password=" +this.password)
    .subscribe((res) =>{
